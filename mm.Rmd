...
# For the questions where there's two people, take the VoD_log_gmod between them
median_forecasters <- median_forecasters %>%
  group_by(ID) %>%
...
ggplot(VoD_quantiles, aes(x = ID, y = median)) +
  ...
  labs(x = "Question ID", y = "VoD_log_gmod_easy", title = "VoD_log_gmod_easy for each question, quartiles") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

ggsave("VoD_log_gmod_easy.png", width = 15, height = 10)
```
